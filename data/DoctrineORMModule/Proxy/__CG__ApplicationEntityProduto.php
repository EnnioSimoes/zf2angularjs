...
class Produto extends \Application\Entity\Produto implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Produto' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Produto' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Produto' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Produto' . "\0" . 'categoria');
        }
